...
class PortfolioSettings(models.Model):
    user = models.OneToOneField('authentication.User', on_delete=models.CASCADE, related_name='portfolio_settings')
...
class SocialLinks(models.Model):
    user = models.OneToOneField('authentication.User', on_delete=models.CASCADE, related_name='social_links')
...
class PortfolioSection(models.Model):
    ...
    user = models.ForeignKey('authentication.User', on_delete=models.CASCADE, related_name='portfolio_sections')
